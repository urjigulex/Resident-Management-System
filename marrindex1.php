...
<?php include('marrmodal_add1.php'); ?>
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                            ...
                            <thead>
                                <tr>
								 <th style="text-align:center;" >HImage</th>
								  <th style="text-align:center;" >Wimage</th>
									<th style="text-align:center;" >HFirst Name</th>
                                    <th style="text-align:center;">HMiddle Name</th>
                                   
                                    <th style="text-align:center;">WFirst Name </th>
                                    <th style="text-align:center;">WMiddle Name</th>
                            ...
                            <tbody>
								...
								$result= mysql_query("select * from marriage order by reg_no ASC" ) or die (mysql_error());
								...
								<td style="text-align:center; word-break:break-all; width:300px;"> <?php echo $row ['hfirstname']; ?></td>
								<td style="text-align:center; word-break:break-all; width:200px;"> <?php echo $row ['hmiddlename']; ?></td>
								
								<td style="text-align:center; word-break:break-all; width:200px;"> <?php echo $row ['wfirstname']; ?></td>
								<td style="text-align:center; word-break:break-all; width:200px;"> <?php echo $row ['wmiddlename']; ?></td>
								...
								<td style="text-align:center; width:350px;">
									<a href="marredit1.php<?php echo '?id='.$id; ?>" class="btn btn-info"><font color="white" size="3"> Edit</a>
									 <a href="#delete<?php echo $id;?>"  data-toggle="modal"  class="btn btn-danger" ><font color="white" size="3"> Delete </a>
									 <a href="marrc.php<?php echo '?id='.$id; ?>" class="btn btn-info"><font color="white" size="3"> View</a>
								</td>
								...
								<a href="marrdelete1.php<?php echo '?reg_no='.$id; ?>" class="btn btn-danger">Yes</a>
								</div>
								</div>
								</div>
								</tr>
								...
								<h3 id="myModalLabel"><b><?php echo $row['hfirstname']." ".$row['hmiddlename']; ?></b></h3>
								</div>
								<div class="modal-body">
								<?php if($row['hlocation'] != ""): ?>
								<img src="upload/<?php echo $row['hlocation']; ?>" style="width:390px; border-radius:9px; border:5px solid #d0d0d0; margin-left: 63px; height:387px;">
								<?php else: ?>
								...
								<div class="modal-body">
								<?php if($row['wlocation'] != ""): ?>
								<img src="upload/<?php echo $row['wlocation']; ?>" style="width:390px; border-radius:9px; border:5px solid #d0d0d0; margin-left: 63px; height:387px;">
								<?php else: ?>
								<img src="images/default.png" style="width:390px; border-radius:9px; border:5px solid #d0d0d0; margin-left: 63px; height:387px;">
								<?php endif; ?>
								</div>
