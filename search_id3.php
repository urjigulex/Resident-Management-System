...
<li class="active"><a href="logout.php"><font color="white" size="4" face="elephant">Logout</font> </a></li>
 ...
 <div id="tooplate_main" class="shadow">
  <center>
<h2>Divorce Verification</h2>
<form action="search_id3.php" method="POST" name="form">
<strong>
Enter hasband Name :</strong>
<input name="searchname" type="text"> 
<br> <br>
<strong>
Enter Wife Name :</strong>
...
{
$no=$_POST['searchid'];
$hfirstname=$_POST['searchname'];
$wfirstname=$_POST['searchfname'];

$sql = "SELECT * FROM marriage where reg_no='$no' and hfirstname='$hfirstname' and wfirstname='$wfirstname'";
...
if ($records==0)
{
echo '<script type="text/javascript">alert("You Are Not marreiege!");
window.location=\'search_id3.php\';</script>'.mysql_error();
}
else

echo '<script type="text/javascript">alert("YOU CAN TO GIVE CERTIFICATE!");window.location=\'divindex1.php\';</script>';
