...
<html lang="en">
    <head>
        ...
        <title>Kebele resident Managmnet System</title>

        <link href="csss/bootstrap.css" rel="stylesheet" type="text/css" media="screen">
...
<script src="jss/bootstrap.js" type="text/javascript"></script>
