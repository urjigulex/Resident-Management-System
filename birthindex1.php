                        ...
                        <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                            ...
                            <thead>
                                <tr>
									...
									<th style="text-align:center;" >Child Full Name</th>
                            ...
                            <tbody>
								...
								$result= mysqli_query($con,"select * from birth order by reg_no ASC" ) or die (mysqli_error($con));
								...
								<td style="text-align:center; word-break:break-all; width:200px;"> <?php echo $row ['childfullname']; ?></td>
								...
								<td style="text-align:center; word-break:break-all; width:200px;"> <?php echo $row ['motherfullname']; ?></td>
								<td style="text-align:center; word-break:break-all; width:200px;"> <?php echo $row ['mage']; ?></td>
								<td style="text-align:center; word-break:break-all; width:200px;"> <?php echo $row ['fatherfullname']; ?></td>
								<td style="text-align:center; word-break:break-all; width:200px;"> <?php echo $row ['fage']; ?></td>
							
								
								
								<td style="text-align:center; width:350px;">
									<a href="birthedit.php<?php echo '?id='.$id; ?>" class="btn btn-info"><font color="white" size="3">Edit</a>
									 <a href="#delete<?php echo $id;?>"  data-toggle="modal"  class="btn btn-danger" ><font color="white" size="3">Delete </a>
									 <a href="birthc.php<?php echo '?id='.$id; ?>" class="btn btn-info"><font color="white" size="3">View</a>
								</td>
								...
								<a href="birthdelete1.php<?php echo '?reg_no='.$id; ?>" class="btn btn-danger">Yes</a>
								</div>
								</div>
								</div>
								</tr>
								...
								<h3 id="myModalLabel"><b><?php echo $row['childfullname']." ".$row['sex']; ?></b></h3>
								</div>
								<div class="modal-body">
