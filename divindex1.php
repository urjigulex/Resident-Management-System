                        ...
                        <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                            ...
                            <tbody>
								...
								<td style="text-align:center; width:350px;">
									<a href="divedit1.php<?php echo '?id='.$id; ?>" class="btn btn-info"> <font color="white" size="3"> Edit</a>
									 <a href="#delete<?php echo $id;?>"  data-toggle="modal"  class="btn btn-danger" ><font color="white" size="3"> Delete </a>
									 <a href="divc.php<?php echo '?id='.$id; ?>" class="btn btn-info"><font color="white" size="3"> View</a>
								</td>
								...
								<a href="divdelete1.php<?php echo '?reg_no='.$id; ?>" class="btn btn-danger">Yes</a>
								</div>
								</div>
								</div>
								</tr>
