        ...
        <div class="span12">
            ...
            <div class="container">
						...
						<th style="text-align:center;" >Image</th>
									...
									<th style="text-align:center;">Place of Death </th>
                            ...
                            <tbody>
								...
								$result= mysqli_query($con,"select * from Death order by reg_no ASC" ) or die (mysqli_error($con));
								...
								<td style="text-align:center; word-break:break-all; width:200px;"> <?php echo $row ['pplaceofbirth']; ?></td>
								<td style="text-align:center; word-break:break-all; width:200px;"> <?php echo $row ['dateofdeath']; ?></td>
								<td style="text-align:center; word-break:break-all; width:200px;"> <?php echo $row ['placeofdeath']; ?></td>	
								<td style="text-align:center; width:350px;">
									<a href="deathedit1.php<?php echo '?id='.$id; ?>" class="btn btn-info"><font color="white" size="3">Edit</a>
									 <a href="#delete<?php echo $id;?>"  data-toggle="modal"  class="btn btn-danger" ><font color="white" size="3">Delete </a>
									 <a href="deathc.php<?php echo '?id='.$id; ?>" class="btn btn-info"><font color="white" size="3">View</a>
								</td>
								...
								<a href="deathdelete1.php<?php echo '?reg_no='.$id; ?>" class="btn btn-danger">Yes</a>
								</div>
								</div>
								</div>
								</tr>
