 ...
 <table border="0" bgcolor="blue" cellspacing="0">
   <tr>
	...
	<table>
			<tr>
				<td>
					<div><b>View Death information</b></div>
					<hr />
						<form action="serde.php" onsubmit='return formValidator()' method='POST'>
						<table>
<tr>
								<td class="search">Enter Name:</td>
							...
							<tr>
								<td class="search">Enter Place of birth:</td>
								<td><input type="text" name="pplaceofbirth" size="40px" placeholder="Provide Here..." /></td>
							<tr>
								<td class="search">Enter Enter place of death:</td>
								<td><input type="text" name="placeofdeath" size="40px" placeholder="Provide Here..." /></td>
...
while($row = mysqli_fetch_array($result))
  ...
  $ctrl = $row['reg_no'];
   ...
   print ("<td>" . $row['placeofdeath'] . "</td>");
   print ("<td>" . $row['causeofdeath'] . "</td>");
   print ("<td>" . $row['timeofdeath'] . "</td>");
   print ("<td>" . $row['date'] . "</td>");
   print ("<td>" . $row['approve'] . "</td>");
   print ("<td>" . $row['remark'] . "</td>");
     print("<td align = 'center' width = '1'> <a href = 'deathc1.php?key1=".$ctrl."'><img width='25px' height='25px' src = 'images/search.png'title='view Death information'>
<img width='25px' height='25px' src = 'images/user.jpg' title='view Death information'></a>
</td>	
