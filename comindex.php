            ...
            <div class="container">
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                            ...
                            <tbody>
								...
								$result= mysql_query("select * from comment order by name ASC" ) or die (mysql_error());
								...
								<td style="text-align:center; width:350px;">
									<a href="comsende.php<?php echo '?id='.$id; ?>" class="btn btn-info"><font color="white" size="3">View</a>
									 <a href="#delete<?php echo $id;?>" data-toggle="modal"  class="btn btn-danger" ><font color="white" size="3">Delete </font></a>
								...
								<a href="delete.php<?php echo '?name='.$id; ?>" class="btn btn-danger">Yes</a>
								</div>
								</div>
								</div>
								</tr>
