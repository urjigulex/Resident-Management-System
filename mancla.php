...
// Use the mysqli_connect() function for the database connection
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                    ...
                    <tbody>
                        <?php
                            ...
                            $result = mysqli_query($con, "SELECT * FROM clark_account ORDER BY phone") or die(mysqli_error($con));
                        ...
                        <tr>
                            ...
                            <td style="text-align:center; width:350px;">
                                <a href="account.php<?php echo '?id='.$id; ?>" class="btn btn-info"><font color="white" size="4">Edit</a>
                            ...
                            <div id="delete<?php echo $id;?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a href="delcla.php<?php echo '?phone='.$id; ?>" class="btn btn-danger">Yes</a>
                                </div>
                            </div>
                        </tr>
                        <?php } ?>
