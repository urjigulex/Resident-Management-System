...
<div >
                                ...
                                <center>
													<?php	
			$ctrl = $_REQUEST['key1'];											$query=mysql_query("select * from resident where reg_no='{$ctrl}'")or die(mysql_error());
														$row=mysql_fetch_array($query);
														//$fname = $row['fname']. " " . $row['mname']. " " . $row['lname'];
														
														?>
												<img src="images/legal.jpg" width="890>
   <div class="row">
			</strong><br />
...
value=<?php echo $row['approve']; ?>></u>
							...
							<center>
<a href="sermyinfo.php"><img src="images/back.jpg" width="90"></a></center>
