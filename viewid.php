...
$ctrl = $_REQUEST['key1'];
  ...
  $query=mysql_query("select * from id_card where id_no='{$ctrl}' ")or die(mysql_error());
$row=mysql_fetch_array($query);
//$row = $query->fetch();
													
  ?>
			<img src="images/id.jpg" width="890>
   <div class="row">
		<div class="col-md-10">
...
Phone number:											
			<u><input type="text" name="phone" style="width:25%;border-top: none; border-left: none;border-right: none;border-bottom: 1px solid;"value=<?php echo $row['phone']; ?>></u>
		...
		<div class="col-md-15">
			...
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="text" name="dateofbirth" style="width:25%;border-top: none; border-left: none;border-right: none;border-bottom: 1px solid;"value=<?php echo $row['renewed_date']; ?>>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					</div>
		</div>
...
<u><img src="images/mwu.jpg" alt="1" title=" " width="120" /></u>
		...
		<div class="col-md-15">
         ...
         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			...
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Signiture:&nbsp;&nbsp;&nbsp;<u><img src="images/Capturs.png" alt="1" title=" " /></u>
							...
							<center>
<a href="serid.php"><img src="images/back.jpg" width="90"></a></center>
