    ...
    <div id="tooplate_main" class="shadow">      
        ...
        <div class="container">
            <div class="row bg-info">
                    ...
                    <legend  align="center"><div class="legend"><b><font color="black" font size="3">Please Enter Your request the space provided below</b></div></legend>
					<br>
					<div>
<form  method="post" action="message.php"name='myform' target="_top"onsubmit='return validate()'>
                        <center>
                            <fieldset >
                                ...
                                if ($lng != "amar")
                                    ...
                                    echo " ?? ";
                                ?>  <input type="text"  name="reg_no" required pattern="[0-9]{1,}"  placeholder="please enter Your Reg_no"  /> <br><br>
                                <?php
                                if ($lng != "amar")
                                    ...
                                    echo " ?? ";
                                ?>  <input type="text" id="span9001" name="fname" required pattern="[A-Z a-z]{3,}" placeholder="please enter Your Firstname"  /> 
                                <br><br>
                                        <?php
                                        if ($lng != "amar")
                                            echo " Last name ";
                                            ...
                                            echo " ???? ?? ";
                                        ?><input type="text" id="span9001" name="lname" required pattern="[A-Z a-z]{3,}" placeholder="please enter Your Middlename" />                                        <br><br>
                                                <?php
                                                if ($lng != "amar")
                                                    echo " email ";
                                                else
                                                ...
                                                ?> <input type="text"pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" name="email" required placeholder="please enter Your E_mail"  /> 
                                                ...
                                                ?><select name="rtype" required><br>
                                                        ...
                                                        <option >give Birth certificate</option>
																									<option>give Death certificate</option>
                                                ...
                                                if ($lng != "amar")
                                                    ...
                                                    echo " ";
                                                ?><textarea name="message" placeholder="Enter Message if you have?"  ></textarea>
                                                    <br><br>
...
//$uid='user'.$k;
                        ...
                        mysql_query("insert into  messages(reg_no, fname, lname, rtype, message,email,message_date)
	values
	('$reg_no','$fname','$lname', '$rtype', '$message','$email','$message_date')") or die(mysql_error());
                        ?>
