	...
	include('db.php');
                    ...
                    if (!isset($_FILES['image1']['tmp_name'])) {
							...
							if ($error > 0){
								...
								mysql_query("insert into marriage  (reg_no,hid_no,hfirstname,hmiddlename,hlastname,hage,hdateofbirth,hplaceofbirth,hnation,
								hstatus,hmothername,hmothernation,wid_no,wfirstname,wmiddlename,wlastname,wage,wdateofbirth,wplaceofbirth,wnation,
								wstatus,wmothername,wmothernation, hlocation,wlocation,datemarriage,placemarriage,timemarriage,approvedby,dateapprove,wittness1,wittness2,wittness3) 
								
						values('$reg_no','$hid_no','$hfirstname','$hmiddlename','$hlastname','$hage','$hdateofbirth','$hplaceofbirth',
						'$hnation','$hstatus','$hmothername','$hmothernation','$wid_no','$wfirstname','$wmiddlename','$wlastname',
						'$wage','$wdateofbirth','$wplaceofbirth','$wnation','$wstatus','$wmothername','$wmothernation','$hlocation','$wlocation',
						'$datemarriage','$placemarriage','$timemarriage','$approvedby','$dateapprove','$wittness1','$wittness2','$wittness3')")or die(mysql_error());
									
									}
										header('location:marrindex.php');
									}
							}}
?>								
