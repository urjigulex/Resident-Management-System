...
<th style="text-align:center;" >Date of Post</th>						<th style="text-align:center;" >Name</th>
                            ...
                            <tbody>
								...
								$result= mysqli_query($con,"select * from smad order by reg_no DESC" ) or die (mysqli_error($con));
								while ($row= mysqli_fetch_array ($result) ){
								$id=$row['reg_no'];
								?>
								
								<tr>
								<td style="text-align:center; word-break:break-all; width:200px;"> <?php echo $row ['reg_no']; ?></td>
		...
		<td style="text-align:center; word-break:break-all; width:200px;"> <?php echo $row ['message_date']; ?></td>								
								...
								<td style="text-align:center; word-break:break-all; width:200px;"> <?php echo $row ['type']; ?></td>
								...
								<a href="delete2.php<?php echo '?reg_no='.$id; ?>" class="btn btn-danger">Yes</a>
								</div>
								</div>
								</div>
								</tr>
