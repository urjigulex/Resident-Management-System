 ...
 <table border="0" bgcolor="blue" cellspacing="0">
   <tr>
	...
	<table align="center">
			<tr>
				<td>
					<div><b>View Birth information</b></div>
					<hr />
						<form action="serbi.php" onsubmit='return formValidator()' method='POST'>
						<table>
							<tr>
								<td class="search">Enter Your name:</td>
								<td><input type="text" name="childfullname" size="40px" placeholder="Provide Here..." value="<?php echo ucfirst($_SESSION['username']); ?>" readonly="readonly"/></td>

								<tr><td class="search">Enter your Mother name:</td>
								<td><input type="text" name="motherfullname" size="40px" placeholder="Provide Here..." /></td>
<tr>
								<td class="search">Enter Your Father name:</td>
								<td><input type="text" name="fatherfullname" size="40px" placeholder="Provide Here..." /></td>

								<td><input type="submit" value="Verify" name="search" style="cursor:pointer;"/></td>
							</tr>
						</table>
						</form>
					<?php
...
while($row = mysql_fetch_array($result))
  ...
  $ctrl = $row['reg_no'];
   ...
   print ("<td>" . $row['childfullname'] . "</td>");	
   print ("<td>" . $row['dateofbirth'] . "</td>");
   print ("<td>" . $row['sex'] . "</td>");
   print ("<td>" . $row['placeofbirth'] . "</td>");
   print ("<td>" . $row['typeofbirth'] . "</td>");
   print ("<td>" . $row['motherfullname'] . "</td>");
   print ("<td>" . $row['mage'] . "</td>");
   print ("<td>" . $row['mnation'] . "</td>");
   print ("<td>" . $row['mreligion'] . "</td>");
   print ("<td>" . $row['moccupation'] . "</td>");
   print ("<td>" . $row['maddress'] . "</td>");
   print ("<td>" . $row['mtel'] . "</td>");
   print ("<td>" . $row['fatherfullname'] . "</td>");
   print ("<td>" . $row['fage'] . "</td>");
   print ("<td>" . $row['fnation'] . "</td>");
   print ("<td>" . $row['freligion'] . "</td>");
   print ("<td>" . $row['foccupation'] . "</td>");
   print ("<td>" . $row['faddress'] . "</td>");
   print ("<td>" . $row['ftel'] . "</td>");
   print ("<td>" . $row['datereg'] . "</td>");
   print ("<td>" . $row['approvedby'] . "</td>");
  print("<td align = 'center' width = '1'> <a href = 'vibi.php?key1=".$ctrl."'><img width='25px' height='25px' src = 'images/search.png'title='view Birth information'>
