...
<div class="control-group">
                                    <label class="control-label" for="inputPassword">Religion:</label>
                                    <div class="controls">
                                        <input type="text" name="religion" required value=<?php echo $row['religion']; ?>>
                                    </div>
<div class="control-group">
                                    <label class="control-label" for="inputPassword">Martial Status:</label>
                                    <div class="controls">
                                        <input type="text" name="martial" required value=<?php echo $row['martial']; ?>>
                                    </div>
<div class="control-group">
                                    <label class="control-label" for="inputPassword">Mother Tongue:</label>
                                    <div class="controls">
								...
								<div class="control-group">
								 ...
								 <div class="control-group">
                                    <div class="controls">
										...
										<a href="viewpop1.php" class="btn">Back</a>
                                    </div>
                                </div>
                            </form>
...
$relgion_save= $_POST['religion'];
$martial_save= $_POST['martial'];
...
mysql_query("UPDATE resident SET fname = '$fname_save' , mname = '$mname_save' , lname ='$lname_save' ,sex ='$sex_save',dateofbirth ='$dateofbirth_save',placeofbirth ='$placeofbirth_save',region ='$region_save',religion='$relgion_save',martial='$martial_save',language='$language_save',zone ='$zone_save',woreda ='$woreda_save',
