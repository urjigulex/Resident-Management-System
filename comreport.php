                        ...
                        <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                            ...
                            <thead>
                                <tr>
									...
									<th style="text-align:center;" >Residents id</th>
									<th style="text-align:center;">report_type</th>
                            ...
                            <tbody>
								...
								$result= mysqli_query($con,"select * from report no" ) or die (mysqli_error($con));
								while ($row= mysqli_fetch_array ($result) ){
								$id=$row['no'];
								?>
								
								<tr>
								<td style="text-align:center; word-break:break-all; width:300px;"> <?php echo $row ['no']; ?></td>								<td style="text-align:center; word-break:break-all; width:300px;"> <?php echo $row ['message_date']; ?></td>						<td style="text-align:center; word-break:break-all; width:300px;"> <?php echo $row ['Residents_id']; ?></td>
								<td style="text-align:center; word-break:break-all; width:200px;"> <?php echo $row ['report_type']; ?></td>
								<td style="text-align:center; word-break:break-all; width:200px;"> <?php echo $row ['report']; ?></td>
								...
								<td style="text-align:center; width:350px;">
									<a href="reportsend.php<?php echo '?id='.$id; ?>" class="btn btn-info"><font color="white" size="3">View</a>
								...
								<a href="deleteee.php<?php echo '? no='.$id; ?>" class="btn btn-danger">Yes</a>
								</div>
								</div>
								</div>
								</tr>
