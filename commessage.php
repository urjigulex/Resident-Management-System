...
<th style="text-align:center;">reg_no</th>
									...
									<th style="text-align:center;">message_date</th>									<th style="text-align:center;">R_type</th>
                            ...
                            <tbody>
								...
								$result= mysqli_query($con,"select * from messages order by  message_id DESC" ) or die (mysqli_error($con));
								while ($row= mysqli_fetch_array ($result) ){
								$id=$row['message_id'];
								?>
								
								<tr>
								<td style="text-align:center; word-break:break-all; width:300px;"> <?php echo $row ['message_id']; ?></td>								<td style="text-align:center; word-break:break-all; width:300px;"> <?php echo $row ['reg_no']; ?></td>
								...
								<td style="text-align:center; width:350px;">
									<a href="messagesend.php<?php echo '?id='.$id; ?>" class="btn btn-info"><font color="white" size="4">View</a>
									 <a href="#delete<?php echo $id;?>"  data-toggle="modal"  class="btn btn-danger" ><font color="white" size="4">Delete </a>
		<a href="certificate.php" class="btn btn-success"><font color="white" size="4"> Give Certificate</a></font>
