                        ...
                        <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                            ...
                            <tbody>
								...
								<td style="text-align:center; width:350px;">
								 <a href="birthc.php<?php echo '?id='.$id; ?>" class="btn btn-info">View</a>
									<a href="birthedit.php<?php echo '?id='.$id; ?>" class="btn btn-info">Edit</a>
								...
								<a href="birthdelete.php<?php echo '?reg_no='.$id; ?>" class="btn btn-danger">Yes</a>
								</div>
								</div>
								</div>
								</tr>
								...
								$childfullname="";
								$sex="";
								echo $row['childfullname']." ".$row['sex']; ?></b></h3>
								</div>
								<div class="modal-body">
								<!--<?php if($row['location'] != ""): ?>-->
