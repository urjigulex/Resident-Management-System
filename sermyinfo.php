 ...
 <table border="0" bgcolor="blue" cellspacing="0">
   <tr>
	...
	<table>
			<tr>
				<td>
<center><b>View My information</b></div>
					<hr />
						<form action="sermyinfo.php" onsubmit='return formValidator()' method='POST'>
						<center><table border="0" border-radius:25px;align="center">
							<tr>
								<td class="search">Your First name:</td>
								<td>
<input type="text" name="fname" size="40px" placeholder="Provide Here..." value="<?php echo ucfirst($_SESSION['username']); ?>" readonly="readonly" /></td></tr>	
				<tr>
								<tr><td class="search">Your Phone num:</td>
<td><input type="text" name="phone" size="40px " placeholder="Provide H ere..."/></td>								<td> <input type="submit" value="Verify" name="search" style="cursor:pointer;"/></td>
							</tr>
						</table>
						</form>
					<?php
