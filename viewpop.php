...
<center>
<ul>
<a href="" class="btn btn-info"><font color="#FFFFFF" SIZE ="6" face="elephant"><b>List of Registered Population in Bate  Kebele</b></font></a><br/>
...
echo"</th>";
echo"<td>";
echo '<font color="#003399">'.$total/$you*100;
echo"</td>";
//
echo"</tr>";
echo"<tr>";
...
echo"</th>";
echo"<td>";
echo '<font color="#003399">'.$tot/$you*100;
echo"</td>";
echo"</tr>";
//@@@@@@@@@@@
echo"</tr>";
...
echo"</th>";
echo"<td>";
echo '<font color="#0033990">'.($total+$tot)/$you*100;
echo"</td>";
echo"</tr>";}}
//@@@@@@@@@@@@@
?>
