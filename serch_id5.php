...
<form action="serch_id5.php" method="POST" >
...
window.location=\'serch_id5.php\';</script>'.mysql_error();
}
else

echo '<script type="text/javascript">alert("You Can to Give Death Certificate!");window.location=\'deathgive.php\';</script>';
