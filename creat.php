...
"black">Create Account for new Users</b></div></legend>
					<br>
					<div><center>
						 <form id="send" action="creat.php" method="post" onsubmit="return validate()">
...
Phone number: <input type="phone"  name="phone" id="Kebele" size="30" color="silver" required pattern="[0-9]{10}" placeholder= "Enter Phone number of the user"><br><br>
	User Account_Type:&nbsp;<input type="text"  name="privilege"id="Kebele" size="30" color="silver" required pattern="[A-Za-z]{5}" value="Clark" readonly="readonly"><br><br>
State:&nbsp;
	...
	<?php	
		...
		elseif($username == ""){
			...
			alert("Please enter your name!")
             ...
             mysqli_query($con,"insert into clark_account(user_id,username,privilege,phone,password,state)
