...
"black">Create Account for new Users</b></div></legend>
					<br>
					<div><center>
						 <form id="send" action="create.php" method="post" onsubmit="return validate()">
	...
	User_Name: <input type="text"  name="username"id="Kebele" size="30" color="silver" required placeholder= "Enter Name of the user" pattern="[A-Za-z]{3,}"><br><br>
Phone number: <input type="phone" name="phone" id="Kebele" size="30" color="silver" required pattern="[0-9]{10}" placeholder= "Enter Phone number of the user"><br><br>
	User Account_Type:&nbsp;<input type="text"  name="privilege"id="Kebele" size="30" color="silver" required pattern="[A-Za-z]{8}" value="Resident" readonly="readonly" ><br><br>
State:&nbsp;
	...
	<?php	
		...
		elseif($username == ""){
			...
			alert("Please enter your name!")
             ...
             mysqli_query($con,"insert into res_account(user_id,username,privilege,phone,password,state)
			...
			<script>
			alert("The Message is Sent successfully to Resident, Thank you!")
				</script>	
					<?php
