       ...
       <div class="container">
        <div class="row bg-danger">
            <div class="noprint"
					...
					<br>
					<div><center>
                        <form action="change_password.php" method="post" name="was">
	  ...
	  mysql_select_db("onlinekebele",$conn);
                    if (isset($_POST['change_password'])) {
                       ...
                       $new_password = $_POST['new_password'];
                        $resulsasst = mysql_query("SELECT * FROM users WHERE username = '$username' and password = '$pass'");
                        $counssst = mysql_num_rows($resulsasst);
                        if ($counssst ==0) {

                            echo "user name  and password is not correct Please Insert Correctly ! ";
                            echo '</strong></div>';
                        } else 
{
