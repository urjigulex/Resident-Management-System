...
<?php
  $ctrl = $_REQUEST['key1'];
												$query=mysql_query("select * from resident where reg_no='{$ctrl}'")or die(mysql_error());
								...
								<div class="control-group">
								 ...
								 <div class="control-group">
                                    <div class="controls">
										...
										<a href="editprofile.php" class="btn">Back</a>
                                    </div>
                                </div>
                            </form>
...
mysql_query(" UPDATE resident SET plocation='$plocation' WHERE reg_no = '$ctrl' ")or die(mysql_error());
...
?>
			...
			$ctrl = $_REQUEST['key1'];
	$query=mysql_query("select * from resident where reg_no='{$ctrl}'") or die(mysql_error());
$result = mysql_query("SELECT * FROM resident WHERE reg_no = '$ctrl'");
...
mysql_query("UPDATE resident SET fname = '$fname_save' , mname = '$mname_save' , lname ='$lname_save' , sex ='$sex_save',dateofbirth ='$dateofbirth_save',placeofbirth ='$placeofbirth_save',region ='$region_save',zone ='$zone_save',woreda ='$woreda_save',
nationality ='$nationality_save',houseno ='$houseno_save',occupation ='$occupation_save',phone ='$phone_save' WHERE reg_no = '$ctrl'") or die(mysql_error()); 	
